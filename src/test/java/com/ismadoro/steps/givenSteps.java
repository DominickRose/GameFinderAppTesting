...
public class givenSteps {
    ...
    public void The_User_is_on_the_Dashboard() throws InterruptedException {
    ...
    public void the_User_is_on_the_Search_page_with_search_results() throws InterruptedException {
        BasicRunner.driver.get("http://localhost:63342/DomGameFinderApp/pages/home.html");
        BasicRunner.navbarPage.banner.click();
