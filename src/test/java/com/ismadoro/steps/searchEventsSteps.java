...
public class searchEventsSteps {
    ...
    public void the_search_updates_to_only_shown_events_from_that_state() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @When("The User enters a city name in the City field")
    public void the_User_enters_a_city_name_in_the_City_field() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @Then("The search updates to only show events from that city")
    public void the_search_updates_to_only_show_events_from_that_city() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
