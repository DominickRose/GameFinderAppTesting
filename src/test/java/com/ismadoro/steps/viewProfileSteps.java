...
public class viewProfileSteps {
    ...
    public void the_User_is_taken_to_the_Search_Results_page_with_a_list_of_all_players_matching_their_search() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void they_are_taken_to_that_Player_s_Profile_page() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Then("They are taken to a private version of that Player's Profile page")
    public void they_are_taken_to_a_private_version_of_that_Player_s_Profile_page() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
